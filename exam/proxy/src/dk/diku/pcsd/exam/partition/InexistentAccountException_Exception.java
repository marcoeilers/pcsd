 ...
 * 
 */
@WebFault(name = "InexistentAccountException", targetNamespace = "http://partition.exam.pcsd.diku.dk/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: dk.diku.pcsd.exam.partition.InexistentAccountException
     */
