 ...
 * 
 */
@WebServiceClient(name = "KeyValueBaseImplServiceService", targetNamespace = "http://impl.assignment1.pcsd.diku.dk/", wsdlLocation = "http://kaninbyen.cloudapp.net:4242/server/keyvaluebase?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://kaninbyen.cloudapp.net:4242/server/keyvaluebase?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://kaninbyen.cloudapp.net:4242/server/keyvaluebase?wsdl', retrying as a local file");
