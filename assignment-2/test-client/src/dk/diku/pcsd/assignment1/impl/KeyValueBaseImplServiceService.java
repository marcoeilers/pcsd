 ...
 * 
 */
@WebServiceClient(name = "KeyValueBaseImplServiceService", targetNamespace = "http://impl.assignment1.pcsd.diku.dk/", wsdlLocation = "http://localhost:8080/server/keyvaluebase?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://localhost:8080/server/keyvaluebase?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://localhost:8080/server/keyvaluebase?wsdl', retrying as a local file");
